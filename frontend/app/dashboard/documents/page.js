  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="font-montserrat text-sm text-gray-500 mt-1">
            Securely store and manage your financial documents
          </p>
        </div>
        <div className="flex items-center gap-3">
          <select
            className="px-3 py-2.5 border border-gray-200 rounded-lg font-montserrat text-sm text-gray-700 bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all hover:border-gray-300 shadow-sm"
          ...
          <button
            ...
            disabled={uploading}
            className="bg-gradient-to-r from-primary to-primary-dark text-white px-5 py-2.5 rounded-lg font-montserrat text-sm font-medium hover:shadow-lg transition-all duration-200 hover:-translate-y-0.5 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {uploading ? (
              <>
      ...
      {shareModal && (
        ...
        >
          <div
            className="bg-white rounded-xl p-6 w-full max-w-md shadow-2xl animate-in zoom-in duration-200"
          ...
          >
            ...
            <form onSubmit={handleShare} className="space-y-4">
              ...
              <div className="flex gap-3">
                <button
                  type="submit"
                  className="bg-gradient-to-r from-primary to-primary-dark text-white px-5 py-2.5 rounded-lg font-montserrat text-sm font-medium hover:shadow-lg transition-all duration-200"
                >
                  Share
                </button>
                <button
                  type="button"
                  onClick={() => setShareModal(null)}
                  className="px-5 py-2.5 border border-gray-200 rounded-lg font-montserrat text-sm text-gray-600 hover:bg-gray-50 hover:border-gray-300 transition-all duration-200"
                >
                  Cancel
                </button>
              </div>
      ...
      {/* Drop Zone */}
      <div
        className="border-2 border-dashed border-gray-200 rounded-xl p-10 text-center hover:border-primary/50 hover:bg-primary/5 transition-all duration-300 cursor-pointer group"
        onClick={() => fileRef.current?.click()}
        onDragOver={(e) => {
          e.preventDefault();
      ...
      >
        <div className="w-16 h-16 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:from-primary/20 group-hover:to-secondary/20 transition-all">
          <svg
        ...
        <p className="font-montserrat text-sm font-medium text-gray-700 mb-1">
              ...
              <thead>
                <tr className="border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                  {["Name", "Size", "Uploaded", "Actions"].map((h) => (
                    <th
                      key={h}
                      className="font-montserrat text-xs font-semibold text-gray-600 py-3 px-4 uppercase tracking-wider"
                    >
                      {h}
                    </th>
                  ))}
              ...
              <tbody>
                {documents.map((doc) => {
                  ...
                  return (
                    <tr
                      key={doc.id}
                      className="border-b border-gray-50 hover:bg-gradient-to-r hover:from-gray-50 hover:to-transparent transition-all duration-200"
                    >
