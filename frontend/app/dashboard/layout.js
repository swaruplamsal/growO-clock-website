  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex">
        {/* Sidebar */}
        <aside
          className={`fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 transform transition-transform duration-300 lg:translate-x-0 lg:static lg:inset-auto shadow-xl ${
            sidebarOpen ? "translate-x-0" : "-translate-x-full"
          }`}
        >
          <div className="flex flex-col h-full">
            {/* Logo */}
            <div className="flex items-center justify-between h-16 px-6 border-b border-gray-100 bg-gradient-to-r from-primary/5 to-secondary/5">
            ...
            <div className="p-4 border-t border-gray-100 bg-gradient-to-r from-gray-50 to-white">
              ...
              <button
                ...
                className="w-full px-3 py-2 text-sm font-montserrat font-medium text-red-600 hover:bg-red-50 rounded-lg transition-all duration-200 text-left hover:shadow-sm"
              >
                Sign Out
              </button>
            </div>
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-30 shadow-sm">
            <button
              className="lg:hidden p-2 text-gray-500 hover:text-primary transition-colors hover:bg-primary/5 rounded-lg"
            ...
            <Link
              href="/"
              className="font-montserrat text-sm text-gray-600 hover:text-primary transition-all duration-200 flex items-center gap-2 hover:gap-3"
            >
              <svg
                className="w-4 h-4"
                fill="none"
